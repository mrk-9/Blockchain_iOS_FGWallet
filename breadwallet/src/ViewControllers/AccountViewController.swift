...
class AccountViewController : BaseViewController, Subscriber {
    ...
    init(sender: MenuLeft, store: Store, didSelectTransaction: @escaping ([Transaction], Int) -> Void) {
        self.store = store
